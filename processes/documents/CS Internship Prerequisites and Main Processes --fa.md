...
## مقدمه
در این مستند به معرفی پیش‌نیازها و قسمتی از فرآیندهای اصلی برنامه CS Internship می‌پردازیم که لازم است قبل از ورود به برنامه با آنها آشنا باشید. با فرآیندهای دیگری که وجود دارد، بعد از ورود به برنامه و در طی مسیر آن آشنا خواهید شد.
...
تمامی ارتباطات در برنامه CS Internship از طریق گروه‌ها و کانال‌های تلگرامی مربوط به برنامه صورت می‌گیرد. شما بعد از ورود به برنامه به این گروه‌ها و کانال‌ها اضافه خواهید شد و با کارکرد‌ آنها آشنا می‌شوید. بنابراین صحبت‌هایی که در این گروه‌ها و کانال‌ها صورت می‌گیرد به رسمیت شناخته می‌شود و قابل پیگیری است.
...
۳. **جبران بهم ریختگی پیش آمده:** وقتی من به حرف خود عمل نکرده‌ام، عملا باعث بهم ریختگی در برنامه دیگران و در نهایت بهم ریختگی سیستم شده‌ام. در این صورت وظیفه و تعهد خود می‌دانم که هر کاری در توانم باشد را برای رفع این بهم ریختگی که برای بقیه به وجود آورده‌ام انجام دهم.  
...
یکی از اهداف دیگر برنامه‌ی CS Internship، یادگیری از طریق آموزش به دیگران است. این فرآیند از استپ سوم برنامه آغاز می‌شود؛ جایی که اینترن‌ها با ایفای نقش «همیار فنی»، جلساتی با عنوان «همیاری فنی» برای هم‌دوره‌ای‌های خود در استپ های قبلی برگزار می‌کنند. در این نقش، اینترن‌ها هم به رشد فردی دست پیدا می‌کنند و هم به دیگران خدمت‌رسانی می‌کنند.
