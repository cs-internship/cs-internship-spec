...
![image](https://github.com/user-attachments/assets/eac83aed-a972-4b4d-8e6c-914c5aaa9b31)
...
5. حذف نام اینترن از لیست افرادی که می‌توان با آنها در استپ صفر مصاحبه کرد و به‌روزرسانی اطلاعات آن لیست. این لیست در گروه تلگرامی CS Internship - Coordination بخش General می‌باشد، کوردینیتور با ثبت یک پیام در گروه CS Internship - Mentors، خروج اینترن را اعلام کرده و درخواست می‌کند که لیست اصلاح شود. ویرایش و به‌روزرسانی توسط کاربری که مجوز آن را دارد انجام خواهد شد.
...
5. کوردینتور آدرس Outlook اینترن را در گروه CS Internship - Mentors ارسال کرده و از منتورها درخواست می‌کند که دسترسی اژر را حذف کنند.
