...
### برگزارکننده اول  
این نقش توسط یکی از منتورها یا کاندیدهای منتوری انتخاب می‌شود و مسئولیت اصلی او، پیش‌بردن جلسه و پاسخ به سوالات متقاضیان است.

### برگزارکننده دوم  
این نقش نیز از میان منتورها یا کاندیدهای منتوری انتخاب می‌شود و مسئولیت‌های زیر را بر عهده دارد:

- حداقل ۱۵ دقیقه پیش از شروع جلسه، جلسه را برای ورود متقاضیان آماده کند (پیشنهاد می‌شود کمی زودتر وارد شود تا همه چیز به‌موقع آماده باشد).
- با **اکانت CS Internship** وارد جلسه شود.
- صفحه خود را **شیر (اشتراک‌گذاری)** کند و پیام خوش‌آمدگویی را نمایش دهد.
- **۱۵ دقیقه مانده به شروع رسمی جلسه**، در گروه صف پیام شروع جلسه را ارسال کند.
...
> **نکته:** با توجه به اینکه بهتر است منتورها در جلسه با نام و نام خانوادگی واقعی خود مشخص باشند، می‌توانند همزمان با **اکانت شخصی** و **اکانت CS Internship** وارد جلسه شوند. پس از قفل و ضبط جلسه، می‌توان اکانت CS Internship را از جلسه خارج کرد.
...
در ابتدای جلسه، برگزارکننده اول نقش‌های حاضر را معرفی می‌کند:  
- چه کسانی برگزارکننده هستند.  
- مشاهده‌گر چه کسی است.  
- توضیح داده می‌شود که مشاهده‌گر در طول جلسه صحبت نمی‌کند و صرفاً برای مشاهده روند جلسه حضور دارد.
...
در صورتی که فردی بدون طی کردن مراحل قبل در جلسه حاضر شده باشد، در انتهای جلسه به او اطلاع داده می‌شود که لازم است مراحل را به ترتیب طی کند.
