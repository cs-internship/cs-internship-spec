...
تسهیل‌گر مصاحبه به شخصی گفته می‌شود که مسئول آماده‌سازی جلسه مصاحبه برای حضور شرکت‌کنندگان است و همچنین مسئول برگزاری و مدیریت جلسه Debrief مصاحبه است. در جلسه Debrief از مصاحبه‌کنندگان، کووردینیتورها و مشاهده‌گر جلسه مصاحبه دعوت به عمل می‌آید. وظیفه تسهیل‌گر در این جلسه این است که طبق دستور العمل وظایف خود، از افراد حاضر در جلسه بخواهد که در باره احساسات و مشاهدات خود صحبت کنند. این نقش میتواند به فردی از سطح‌های دستیارمنتور یا کاندیدمنتور و یا منتور واگذار می‌شود. 
...
تسهیل‌گر (Facilitator): تسهیل‌گر مصاحبه به شخصی گفته می‌شود که مسئولیت آماده‌سازی جلسه مصاحبه و مدیریت جلسه Debrief را بر عهده دارد.
