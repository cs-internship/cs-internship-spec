...
زمانی که یک اینترن تصمیم می‌گیرد نقش همیار فنی را بپذیرد یا در صورتی که در حال حاضر همیار فنی است و می‌خواهد سطح خود را ارتقا دهد، باید ابتدا این موضوع را به کوردینیتور خود اعلام کند. این اعلام به‌معنای آمادگی برای ورود به نقش یا سطح جدید است.

پس از اعلام، کوردینیتور از اینترن می‌خواهد زمان پیشنهادی برای برگزاری جلسه بررسی تغییر سطح را اعلام کند. 

کوردینیتور باید سه اقدام اصلی را انجام دهد:
۱- تنظیم موارد در Azure Board
۱-۱- اگر اینترن قرار است همیار فنی شود:

باید برای او یک تسک در بکلاگ Technical Sessions ایجاد شود:

عنوان تسک شامل نام اینترن به همراه مسیر آموزشی مانند "C#" یا "ML" باشد.

زمان پیشنهادی از طرف اینترن دریافت شده و تسک در همان روز و ساعت ثبت شود.

تسک باید دقیقاً در بخش مربوط به روز و ساعت پیشنهادی در Technical Sessions قرار گیرد.

۱-۲-	اگر فقط تغییر سطح همیار فنی انجام می‌شود:

تسک‌ مرتبط با اینترن به بکلاگ سطح جدید (مثلاً فنی سطح دو) منتقل می‌شوند.
...
وارد Microsoft Teams شوید و روی گروه مربوط به جلسات فنی (Technical Sessions) کلیک کنید.

روی فلش کنار دکمه‌ی Meet کلیک کرده و گزینه‌ی Schedule a meeting را انتخاب کنید.

![image](https://github.com/user-attachments/assets/9e64d047-c51c-4cf6-9d18-676d0a962d90)

فرم جلسه را به این شکل تکمیل کنید:

Title: نام اینترن + مسیر دوره (مثل "Web" یا "C#") + روز هفته + ساعت اعلام‌شده

Time: ساعت ثابتی که اینترن برای جلساتش اعلام کرده

Date: نیازی به تغییر تاریخ نیست (همان تاریخ پیش‌فرض باقی بماند)

Attendees: نیازی به اضافه یا تغییر افراد حاضر نیست

Repeat: حتماً روی گزینه‌ی Weekly تنظیم شود

Recording: گزینه‌ی Record automatically فعال شود
...
وارد گروه تلگرام Coordination Meeting شوید.

پیام پین‌شده‌ی قبلی که مربوط به جلسات فنی است را کپی کنید (برای آرشیو شخصی یا مستندسازی).

سپس پیام پین‌شده‌ی قبلی را Unpin کنید.

پیام جدید را با اطلاعات همیار فنی و لینک جلسه‌ای که از Teams کپی کرده‌اید بنویسید و ارسال کرده و پین کنید.

کوردینیتور باید حداقل یک‌بار وارد جلسه‌ی Teams بشه تا مطمئن بشه که گزینه‌ی ضبط خودکار (Record automatically) به‌درستی فعال شده و جلسه به‌طور خودکار ضبط میشه.
