...
6. Download and Install the latest versions of VS Code.
7. Implement a calculator layout **exactly** like the Windows 10 calculator in maximum size (Standard mode):
...
12. At least 10 days before your deadline, start coordinating and scheduling your live presentation session as the final task of this step.  
