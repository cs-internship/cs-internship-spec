...
- **اقلام مطالعاتی (Study Item):** این‌ها منابع و مطالبی هستند که باید توسط اینترن در مسیر یادگیری مهارت‌های فنی مطالعه شوند. به هر یک از این منابع مطالعاتی اصطلاحاً یک قلم مطالعاتی (study item) گفته می‌شود. یک قلم مطالعاتی می‌تواند بخشی از یک کتاب، یک ویدیو آموزشی و یا یک مقاله باشد.
- 
- **کارها (Tasks):** برای هر استپ، یک سری کارهای خاص تعریف شده است که اینترن برای تکمیل آن استپ نیاز دارد آن‌ها را با موفقیت انجام دهد. به این کارها اصطلاحاً تَسک‌ (task) گفته می‌شود. مثال‌ بعضی از تسک‌ها شامل کارهایی مانند جست‌وجو در وب درباره یک موضوع، مفهوم یا ابزار خاص، انجام یک تمرین برنامه‌نویسی، تمرین تایپ ده انگشتی و فعالیت در سایت Stackoverlow.com است.
- 
- **آموزش‌های منتوری:** در هر استپ، یک سری فعالیت‌ها برای آموزش مهارت‌های کسب‌وکاری که اینترن‌ها برای فعالیت در نقش یک کارآموزمنتور، دستیارمنتور یا منتور به آن‌ها نیاز دارند نیز گنجانده شده‌اند. این فعالیت‌ها تحت عنوان آموزش‌‌های منتوری (Mentor Training) ارائه می‌شوند و عموماْ شامل مشاهده یک سری ویدئوهای آموزشی، نوشتن گزارش‌هایی در مورد مشاهدات خود و شرکت در جلسات گفتگو در مورد مفاهیم مربوطه با منتورها می‌باشند.

همه کارهایی که در هر استپ انجام می‌شوند ب

### نحوه انجام یک استپ

پس از آشنایی با مفهوم استپ، باید بدانیم یک استپ چگونه انجام می‌شود. در ادامه، فرایند کلی برای اجرای هر استپ تشریح می‌شود.

#### اعلام مهلت انجام استپ

در ابتدای هر استپ، یک مستند که کارها و ماموریت‌های آن استپ را تعریف می‌کند توسط کوردینیتوری که به شما تخصیص داده شده است به شما تحویل داده می‌شود. پس از دریافت مستند، شما ۷۲ ساعت فرصت دارید تا محتوای آن را بررسی کرده و زمانی که برای انجام همه کارهای آن استپ نیاز دارید را را برآورد کنید و آن را به عنوان مهلت (deadline) خود برای انجام آن استپ به کوردینیتور خود اعلام کنید. این مهلت که توسط خود شما انتخاب می‌شود به عنوان **قول شما** محسوب می‌شود و لازم است تنها بعد از بررسی دقیق و برنامه‌ریزی مناسب آن را اعلام کنید. 

با اعلام یک deadline برای انجام یا استپ، شما در عمل دارید به دیگران قول می‌دهید که دقیقاْ تا چه تاریخی همه کارهای آن استپ را به طور کامل و با کیفت لازم انجام خواهید داد. از آن به بعد، همه در برنامه روی قول شما حساب می‌کنند و بقیه فرآیندهای برنامه شما برای آن استپ بر اساس این قول شما چیده خواهند شد. این امر کاملا متناظر است با اتقاقی که سر کار در سازمان‌ها یا تیم‌های حرفه‌ای برای شما می‌افتد. در محیط‌های کاری، شما همواره نیاز خواهید داشت به مدیر خود، همکاران خود، سازمان خود یا مشتریان سازمان خود و دیگران قول دهید که یک کار یا پروژه خاص را تا چه زمانی انجام خواهد داد. به محض اینکه چنین قولی دادید، آن افراد و سازمان‌ها به انجام به موقع قول شما وابسته می‌شوند. اگر شما قول خود را سر زمانی که اعلام کرده‌اید انجام ندهید، این امر می‌تواند باعث بروز مشکلات فراوانی برای دیگران شود و گاهاْ خسارات سنگینی به همکاران، سازمان و مشتریان آن که به حرف شما تکیه کرده‌اند وارد کند.
