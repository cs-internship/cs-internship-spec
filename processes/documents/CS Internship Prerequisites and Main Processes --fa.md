...
در برنامه CS Internship، اینترن‌ها همیشه این آزادی را دارند که اگر تشخیص دادند به هر دلیلی قادر به انجام قول خود با کیفیت مناسب در مهلت اعلام شده نیستند، از یک فرآیند خاص برای مذاکره مجدد و تغییر آن قول استفاده کنند. در این فرآیند، یکی از دیگر اینترن‌ها یا منتورهای برنامه به اینترن کمک خواهد کرد تا به بررسی دلایلی که باعث عدم تخمین صحیح میزان کار لازم برای تکمیل استپ (یا عدم تکمیل کارهای مربوطه سر زمانی که توسط خود اینترن تعیین شده بود) بپردازد. با بررسی فرایندهایی که اینترن از آن‌ها برای انجام عملیاتی مانند (۱) شناسایی همه کارهای لازم برای تکمیل استپ، (۲) تخمین میزان زمان لازم برای انجام آن کارها، (۳) برنامه‌ریزی برای انجام آن کارها در زمان‌های مشخص، (۴) نظارت بر روند انجام آن‌ کارها طبق برنامه زمان‌بندی فوق، (۵) آزمودن صحت و کارآمدی هر کار در حین انجام آن‌، (۶) کنترل کیفیت نتیجه نهایی پروژه، (۷) تحویل خروجی پروژه به کوردینیتور خود و (۸) ارائه گزارش کارهای انجام شده، استفاده کرده است، اینترن می‌تواند نسبت به نقاط ضعف و قدرت خود در حوزه مدیریت قول خویش آگاه شود و در صورت نیاز، اقدام به توسعه مهارت‌های لازم نماید. در صورتی که اینترن بتواند فرآیند مذاکره مجدد قول خود را با موفقیت انجام دهد، او اجازه خواهد داشت که مهلت اعلام شده برای استپ را تغییر دهد.

هدف از این فرآیند آن است که اینترن‌ها دید و مهارت‌های لازم برای تغییر قول خود را در محیط‌های کاری و سازمانی به دست آورند. تقریباْ غیر ممکن است که یک مهندس نرم‌افزار همیشه بتواند همه قول‌هایی که به مدیران، همکاران یا مشتریان خود داده است را درست انجام دهد. سوال آن است که هنگامی که یک مهندس نرم‌افزار متوجه می‌شود نمی‌تواند قول خود را برساند، او چگونه در قبال افرادی که روی قول وی حساب می‌کنند رفتار خواهد کرد. فرآیند «مذاکره مجدد قول» در برنامه CS Internship اینترن‌ها را آماده می‌کنند که هر وقت سر کار با چنین شرایطی روبرو شدند، بتوانند در نهایت صداقت، رفتاری کاملاْ حرفه‌ای داشته باشند.
