...
جلسات تصمیم‌گیری عملیاتی در برنامه CS Internship به‌صورت هفتگی برگزار می‌شوند. فاصله بین دو جلسه، یک «اسپرینت» نام دارد. در این جلسات، پیشرفت منتورها بررسی شده و وظایف اسپرینت قبل ارزیابی می‌شود. سپس تسک‌های جدید برای اسپرینت بعدی بین منتورها تقسیم می‌گردد. مدیریت این جلسات می‌تواند بر عهده هر سطحی از منتورها باشد؛ به همین دلیل آشنایی کامل با فرآیند مدیریت جلسه برای همه منتورها ضروری است.
...
با گسترش برنامه و تنوع دوره‌ها، ساختار جلسه تغییر کرد و مسئولیت‌ها تقسیم شد. اکنون جلسات عملیاتی با حضور همه سطوح منتوری (از جمله کارآموزمنتورها و دستیارمنتورها) برگزار می‌شوند. این جلسات فرصتی برای آشنایی تدریجی کارآموزمنتورها با فرآیندها و سیاست‌های برنامه فراهم می‌کنند.
...
- مدیر جلسه باید از آماده‌بودن بک‌لاگ‌های مربوط به سه اسپرینت آینده اطمینان حاصل کند.
- در صورت ناقص‌بودن یا نبودن بک‌لاگ، مدیر باید در گروه منتورها اطلاع‌رسانی کند تا بک‌لاگ‌های موردنیاز ایجاد شوند.
