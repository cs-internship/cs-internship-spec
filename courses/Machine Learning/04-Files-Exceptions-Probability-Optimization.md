...
### Tasks
 ...
 4. Download EURUSD forex data from [this](https://www.histdata.com/download-free-forex-historical-data/?/excel/1-minute-bar-quotes/eurusd/2018) link and then extract and open, after that, show the content with proper Python commands, excluding the use of Pandas, Numpy and Matplotlib.
 ...
 7. At least 10 days before your deadline, start coordinating and scheduling your live presentation session as the final task of this step.  
