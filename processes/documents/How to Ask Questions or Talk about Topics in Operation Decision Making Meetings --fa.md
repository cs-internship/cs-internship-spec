...
به بازه زمانی بین دو جلسه تصمیم‌گیری عملیاتی، یک «اسپرینت» گفته می‌شود

در طول هر اسپرینت، ممکن است افراد با سوالات، چالش‌ها یا ایده‌های جدیدی روبرو شوند. طرح درست این موضوعات در جلسات عملیاتی، نقش مهمی در پیشرفت پروژه‌ها، حل ابهامات و حتی ایجاد فرآیندهای جدید دارد.
...
برای پیشبرد اهداف برنامه CS Internship، فرآیندهای متنوعی طراحی شده‌اند که اجرای آن‌ها نیازمند انجام وظایف مشخصی است. در جلسات تصمیم‌گیری عملیاتی، هر یک از کارآموزمنتورها، دستیارمنتورها و منتورها مسئولیت انجام یک یا چند وظیفه را برای هفته آینده برعهده می‌گیرند.
...
در آغاز هر اسپرینت، مدیر جلسه باید صفحه‌ای جدید برای موضوعات باز آن اسپرینت در OneNote و در بخش [Open Topics](https://onedrive.live.com/view.aspx?resid=A9B215A332F3E600%21392628&id=documents&wd=target%28Team%20Operations%2FMeetings%2FOpen%20Topics.one%7C3E383320-7159-45AB-8B7C-37B212E2410D%2F%29) ایجاد کند.

مراحل ایجاد:

۱- در OneNote به بخش اسپرینت عملیاتی بروید.

۲- با استفاده از دکمه Add Page، یک کپی از قالب صفحه موضوعات باز ایجاد کنید(تصویر ۱)

۳- عنوان پیش‌فرض صفحه را ویرایش کرده و عبارت‌های داخل {} را با شماره اسپرینت جدید و نام تیم جایگزین کنید

برای مثال، مدیر اسپرینت عملیاتی ۱۸۱ باید صفحه اسپرینت ۱۸۰ را بررسی کرده و سپس صفحه جدید اسپرینت ۱۸۱ را ایجاد و تنظیم کند.
...
مطابق مثالی که در بخش ایجاد صفحه موضوعات اسپرینت جاری توسط مدیر جلسه عملیاتی آمده است، مدیر جلسه‌ی عملیاتی ۱۸۱، پیش از شروع جلسه‌ی عملیاتی ۱۸۱، به صفحه‌ی موضوعات باز مربوط به جلسه‌ی ۱۸۰ در بخش Open Topics مراجعه می‌کند. او موضوعات ثبت‌شده در آن صفحه را طی جلسه بررسی می‌نماید. سپس، در پایان جلسه، همان صفحه را که اکنون موضوعات آن بررسی شده‌اند، به بخش آرشیو منتقل می‌کند و در نهایت، صفحه‌ی جدید موضوعات باز برای جلسه‌ی عملیاتی ۱۸۱ را ایجاد می‌کند.

برای انتقال صفحه به آرشیو:

۱- صفحه موردنظر را انتخاب می‌کنیم.

۲- آن را به بخش Topic Archiv[Topic Archive](https://onedrive.live.com/view.aspx?resid=A9B215A332F3E600%21392628&id=documents&wd=target%28Team%20Operations%2FMeetings%2FTopic%20Archive.one%7CCCE5329B-FA07-4FB8-8096-06C3A730397D%2F%29) منتقل می‌نماییم.
