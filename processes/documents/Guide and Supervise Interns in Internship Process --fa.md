...
این مستند به‌طور مشخص نقش و مسئولیت‌های کوردینیتورها را توضیح می‌دهد؛ افرادی که مستقیماً با اینترن‌ها در ارتباط هستند و مسیر مطالعاتی آن‌ها را راهنمایی می‌کنند. همچنین نحوه ارجاع مسائل به منتور یا منتور فنی را هم شرح می‌دهد.

## مخاطب

مخاطبان این مستند کسانی هستند که می‌خواهند نقش کوردینتور را ایفا کنند.
...
- تحویل دادن استپ و ثبت زمانی که اینترن برای پایان استپ متعهد می‌شود
- دریافت گزارشات هفتگی اینترن و اپدیت پروفایل او بر اساس گزارش
- هماهنگی جلسات ارائه‌ی پایان هر استپ (Live Presentation)
- اطلاع دادن در مورد کارهایی که برای اینترن انجام داده است در جلسه عملیاتی و گفتن وقایق مهم
