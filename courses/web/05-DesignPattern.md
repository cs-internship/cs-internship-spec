...
4. Refactor the Todo app to use Knockout.js and use [this tutorial](http://learn.knockoutjs.com/#/?tutorial=intro).
...
6. Pass all lessons on TypingClub.com with 5 stars up to **lesson 285**.

7. Find at least 5 other online resources about client-side JS & Tooling, and explain why you chose them.

8. Find at least 5 other design patterns similar to MVVM, and explain why you chose them.
