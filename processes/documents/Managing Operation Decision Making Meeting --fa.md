...
۴- **ایجاد بک‌لاگ‌های مربوط به تسک‌های روتین هفتگی:**
   - مدیر جلسه باید از آماده‌بودن بک‌لاگ‌های سه اسپرینت آینده اطمینان حاصل کند.
...
9. [Exiting A Mentor](https://github.com/raityvojdani/cs-internship-spec/blob/patch-18/processes/documents/Exiting%20a%20Mentor%20--fa.md)
...
۱- موارد ۱ تا ۶ به‌طور مرتب در هر جلسه اسپرینت توسط بات ایجاد می‌شوند.
