...
هر یک از دوره‌ها آموزشی برنامه CS Internship شامل حدوداْ ۱۰ استپ است، ولی دوره‌های آموزشی مختلف ممکن است تعداد استپ‌های کمتر یا بیشتری داشته باشند.

برای هر استپ از برنامه، یک سری کارها و ماموریت‌ها تعریف شده است که اینترن‌ها برای تکمیل آن استپ و ورود به استپ بعدی ملزم به انجام آن‌ کارها و ماموریت‌ها بر اساس یک سری استانداردهای کیفیتی خاص هستند. مقدار زیادی زمان، فکر و تحلیل روی طراحی هر کدام از این کارها و ماموریت‌ها صرف شده است. هر کدام از آن‌ها با این هدف تعریف شده‌اند که به اینترن‌ها کمک کنند یک سری از مهارت‌های فنی و کسب‌وکاری که برای موفقیت در سازمان‌ها به آن نیاز دارند را به صورت عملی به دست آورند.

بارزترین مثال این امر، همین مساله وجود کارها و ماموریت‌های تعریف شده برای هر استپ است. در هر شغلی که شما به آن وارد خواهید شد، یک سری کارها و ماموریت‌ها از طرف مدیر شما یا سازمان شما برای شما تعریف خواهد شد. انجام موفقیت‌آمیز این کارها نیازمند رعایت یک سری استانداردهای سازمانی است که کیفیت نتیجه کار را برای سازمان تضمین می‌کنند. بنابرین اولین مهارتی که یک اینترن باید به صورت عمیق به دست آورد، دریافت دستورات لازم برای انجام یک کار یا ماموریت خاص، انجام به موقع آن و تحویل نتایج آن کار و گزارش‌های مربوطه به مدیر خویش است. کارها و ماموریت‌های استپ‌ّ‌های برنامه CS Internship طراحی شده‌اند که چنین محیط و شرایطی را برای شما شبیه‌سازی کنند. اگر قرار است شما مشکلی در دریافت، انجام و تحویل برخی از کارها داشته باشید، بهتر است در محیط امن این برنامه متوجه آن شوید و مهارت‌های خود را ارتقاء دهید تا اینکه بروید سر کار و آنجا مدیر شما متوجه شود که شما در این زمینه دچار مشکلاتی هستید.
...
در ابتدای هر استپ، مستند آن استپ توسط ********* منتور ********* به شما تحویل داده می‌شود. پس از دریافت مستند، شما ۷۲ ساعت فرصت دارید تا محتوای آن را بررسی کرده و زمانی که برای انجام همه کارهای آن استپ نیاز دارید را را برآورد کنید و آن را به عنوان مهلت (deadline) خود برای انجام آن استپ به ********* منتور ********* خود اعلام کنید. این مهلت که توسط خود شما انتخاب شده است به عنوان **قول شما** حساب می‌شود. شما در عمل دارید به دیگران قول می‌دهید که دقیقاْ تا چه تاریخی همه کارهای آن استپ را به طور کامل و با کیفت لازم انجام خواهید داد. از آن به بعد، همه در برنامه روی قول شما حساب می‌کنند و بقیه فرایند برنامه شما بر اساس این قول‌های شما چیده خواهد شد.
