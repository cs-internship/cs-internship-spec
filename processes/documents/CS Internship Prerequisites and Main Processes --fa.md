...
- **بودجه بندی زمانی**. فرد لازم است بتواند یک مدت زمان مشخص را برای هر ماه، هر هفته و هر روز کاری به کار خود تخصیص دهد و بقیه زندگی خود را طوری بچیند که تضمین کند می‌تواند این زمان برنامه‌ریزی شده را صرف پروژه‌های خویش نماید. سازمانی که می‌داند یک مهندس نرم‌افزار دورکار به صورت میانگین چند ساعت در روز، هفته، یا ماه صرف کارهای سازمانی خود می‌کند حس بهتری نسبت به پیش رفتن کار دارد. در عین حال، واضح است که در برخی از بازه‌های زمانی، فرد قادر نخواهد بود تعداد ساعاتی را که برای خود بودجه‌بندی کرده است را کار کند. همین که به صورت میانگین ساعاتی که صرف پروژه می‌شود نزدیک به ساعات برنامه‌ریزی شده باشد و فرد به صورت مستمر به اهداف اعلام شده خود برسد، برای اکثر سازمان‌ها کافی است. به منظور شبیه‌سازی این شرایط در برنامه CS Internship، همه اینترن‌ها موظف هستند که تعداد ساعاتی را که به صورت میانگین هر هفته به انجام کارهای برنامه تخصیص می‌دهند را به صورت شفاف و کتبی اطلاع‌رسانی کنند و نسبت به انجام آن تعداد ساعت کار به صورت میانگین تعهد دهند. ولی بر خلاف کارهای سازمانی، اینترن‌ها این اجازه را دارند که در هر زمان که صلاح می‌دانند این تعهد خود را به صورت کتبی تغییر دهند. سازمان‌های بیرونی معمولاْ چنین اجازه‌ای را به کارکنان خود نمی‌دهند. کارکنان سازمان تقریباْ همیشه تحت یک قرارداد کتبی که تعداد ساعات کار ایشان را تعیین می‌کند کار می‌کنند. ولی از آنجا که این برنامه یک برنامه آموزشی است، مشارکت در CS Internship تحت یک قرارداد حقوقی انجام نمی‌شود و اینترن‌ها در ازای ساعات کارکرد خود مبلغی دریافت نمی‌کنند، قوانین برنامه این اجازه را به اینترن‌ها می‌دهد که تعهد خود را به صورت کتبی و یک طرفه (یعنی بدون نیاز به تایید برنامه) تغییر دهند. منتهی، اگر اینترن‌ها نتواننند در مهلت ۱۰ هفته همه کارهای مربوط به یک استپ خاص را کامل کنند، به صورت خودکار از برنامه خارج خواهند شد. این یعنی که فلسفه برنامه آن است که برای CS Internship این مهم نیست که اینترن‌ها چه مقدار زمانی را صرف می‌کنند. همین که همه کارها به موقع و با کیفیت لازم انجام شوند، اینترن می‌تواند به استپ بعدی رود.
