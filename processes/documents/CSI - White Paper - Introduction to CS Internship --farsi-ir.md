...
این مستند برای کسی مناسب است که مستند CS Internship Overview را مطالعه کرده و ویدیو آشنایی با برنامه را دیده است.
...
**دوره سی‌شارپ**: در این دوره شامل مفاهیم اصلی برنامه‌نویسی سی‌شارپ آشنا می‌شوید. برای اطلاع بیشتر از این دوره میتوانید [گام‌های دوره سی‌شارپ](https://github.com/cs-internship/cs-internship-spec/tree/master/courses/csharp) را ببینید.
**دوره وب**: در این دوره با Html،‌ CSS، JavaScript و TypeScript آشنا می‌شوید و نهایتا بصورت خیلی کلی با فریم‌ورک‌های این حوزه آشنایی پیدا می‌کنید. برای اطلاع بیشتر از این دوره میتوانید [گام‌های دوره وب](https://github.com/cs-internship/cs-internship-spec/tree/master/courses/web) را ببینید.
**دوره یادگیری‌ ماشین**: یبلسیبل. برای اطلاع بیشتر از این دوره میتوانید [گام‌های دوره یادگیری ماشین]([https://github.com/cs-internship/cs-internship-spec/tree/master/courses/web](https://github.com/cs-internship/cs-internship-spec/tree/master/courses/Machine%20Learning)) را ببینید.

## اینتگریتی، مهمترین اصل در برنامه 
در برنامه CS Internship یکی از اساسی‌ترین اصولی که به عنوان یه فرهنگ و ابزار قدرتمند برای کارآمدی در تیم‌ها، تمرین و تاکید می‌شود،‌ اصل تمامیت یا اینتگریتی (Integrity) است. استفاده درست از این اصل باعث می‌شود که تیم‌ها بتوانند کارها بصورت موثر و کارآمدی پیش ببرند و نهایتا منجر به خلق ارزش شود.
...
همانطور که گفته شد، در حال حاضر دوره‌های برنامه عبارتند از «توسعه وب»، «برنامه‌نویسی C#» و «یادگیری ماشین». هر فرد فقط می‌تواند در آن واحد در یکی از این دوره‌ها شرکت کند. شرکت‌کنندگان معمولاً بین 25 تا 30 ساعت در هفته روی دوره زمان صرف می‌کنند و بستگی به سرعت یادگیری و حرکت خود، تکمیل کل برنامه معمولاً حدود ۱۵ ماه زمان می‌برد. نهایتا سرعت حرکت هر فرد در برنامه به عهده خود وی است.
