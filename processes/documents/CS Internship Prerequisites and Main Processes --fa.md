...
## مقدمه
در این مستند به معرفی پیش‌نیازها و برخی از فرآیندهای اصلی برنامه CS Internship می‌پردازیم که لازم است قبل از ورود به برنامه با آنها آشنا باشید.  بعد از ورود به برنامه، با فرآیندهای دیگر آن و نیز با جزئیات بیشتر فرآیندهای ذیل آشنا خواهید شد.
...
**دوره سی‌شارپ**: این دوره شامل مفاهیم اصلی برنامه‌نویسی زبان #C و محیط NET. است. همچنین این دوره شامل پروژه‌های ساده برای درک بهتر مفاهیم است که به شما در یادگیری کمک می‌کند. برای اطلاعات بیشتر می‌توانید [گام‌های دوره سی‌شارپ](https://github.com/cs-internship/cs-internship-spec/tree/master/courses/csharp) را ببینید.

**دوره وب**: در این دوره با JavaScript ،CSS ،HTML و TypeScript آشنا می‌شوید و در پروژه‌های مشخص شده، آموخته‌های خود را به صورت عملی تمرین می‌کنید. در این دوره بصورت خیلی کلی با framework های این حوزه آشنایی پیدا می‌کنید. برای اطلاعات بیشتر می‌توانید [گام‌های دوره وب](https://github.com/cs-internship/cs-internship-spec/tree/master/courses/web) را ببینید.

**دوره یادگیری‌ ماشین**: دوره Machine Learning شامل سه مرحله اصلی مبانی زبان پایتون، مبانی علوم داده با ابزارهایی مانند Matplotlib ،Numpy و Pandas، و مبانی یادگیری ماشین با تمرکز بر الگوریتم‌ها و مفاهیم ریاضی است. این دوره مهارت‌های لازم برای تحلیل داده و ایجاد مدل‌های اولیه را ارائه می‌دهد. برای اطلاعات بیشتر می‌توانید [گام‌های دوره یادگیری ماشین](https://github.com/cs-internship/cs-internship-spec/tree/master/courses/Machine%20Learning) را ببینید.
...
با اعلام یک deadline برای تکمیل هر استپ، شما در عمل دارید به دیگران قول می‌دهید که دقیقاْ تا چه تاریخی همه کارهای آن استپ را به طور کامل و با کیفت لازم انجام خواهید داد. از آن به بعد، همه در برنامه روی قول شما حساب می‌کنند و بقیه فرآیندهای برنامه شما برای آن استپ بر اساس این قول شما چیده خواهند شد. این امر کاملا متناظر است با اتقاقی که سر کار در سازمان‌ها یا تیم‌های حرفه‌ای برای شما می‌افتد. در محیط‌های کاری، شما همواره نیاز خواهید داشت به مدیر خود، همکاران خود، سازمان خود یا مشتریان سازمان خود و دیگران قول دهید که یک کار یا پروژه خاص را تا چه زمانی انجام خواهد داد. به محض اینکه چنین قولی دادید، آن افراد و سازمان‌ها به انجام به موقع قول شما وابسته می‌شوند. اگر شما قول خود را سر زمانی که اعلام کرده‌اید انجام ندهید، این امر می‌تواند باعث بروز مشکلات فراوانی برای دیگران شود و گاهاْ خسارات سنگینی به همکاران، سازمان و مشتریان آن که به حرف شما تکیه کرده‌اند وارد کند.
...
یکی از نیازمندی‌های فرآیند مدیریت قول در محیط‌های کاری آن است که فرد به موقع تشخیص دهد که احتمالا به قولش نخواهد رسید و در مورد تغییر آن قول با مدیران، سازمان یا مشتریان خود مذاکره کند. پس در CS Internship شما همیشه این قدرت را دارید که اگر تشخیص دادید به هر دلیلی قادر به انجام قول خود با کیفیت مناسب در مهلت اعلام شده نیستید، از یک فرآیند خاص برای مذاکره مجدد و تغییر آن قول استفاده کنید. در این فرآیند، یکی از اینترن‌ها یا منتورهای برنامه به شما کمک خواهد کرد تا به بررسی دلایلی که باعث عدم تخمین صحیح میزان کار لازم برای تکمیل استپ یا عدم تکمیل کارهای مربوطه سر زمانی که توسط خود شما تعیین شده بود بپردازید. با بررسی فرایندهایی که شما از آن‌ها برای انجام عملیاتی مانند تخمین میزان کار لازم، تخمین میزان زمان لازم برای انجام آن کارها، برنامه‌ریزی برای انجام کارها، نظارت بر روند انجام آن‌ها، تست کردن کارها در ضمن انجام آن‌ها، کنترل کیفیت نتایج نهایی کار، تحویل کار و ارائه گزارش کار استفاده کرده بودید، شما می‌توانید توانایی و مهارت‌های مدیریت قول خود را بهینه نمایید.
