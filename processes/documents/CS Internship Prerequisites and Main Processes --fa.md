...
یکی از دغدغه‌های جدی که همه سازمان‌ها با آن روبرو هستند و به خصوص در تیم‌های دورکاری نمود پیدا می‌کند آن است که مدیریت سازمان مطمئن نیست مهندسین نرم‌افزار دارند وقت خود را روی حل چه مسائلی صرف می‌کنند. اکثر برنامه‌نویس‌ها طبیعتاْ دوست دارند بدون اینکه مجبور باشند به شخص دیگری گزارش دهند که دارند روی چه مسائلی کار می‌کنند، کار خود را انجام دهند. این طبیعی است. ولی یک مهندس نرم‌افزار حرفه‌ای می‌داند که برای عشق خودش کد نمی‌زند، بلکه در راستای تحقق اهداف کسب‌وکاری سازمان یا مشتری خویش کد می‌زند. مهندسین نرم‌افزار می‌دانند که این حق سازمان یا مشتری است که بداند او دارد روی حل چه مسائلی وقت می‌گذارد. 

این یک نکته کلیدی است. کلاْ فرق برنامه‌نویس و مهندس نرم‌افزار آن است که برنامه‌نویس برای لذتی که از پیاده‌سازی آلگوریتم‌های نرم‌افزاری می‌برد کد می‌زند ولی مسئولیت مهندس نرم‌افزار تبدیل آلگوریتم‌های نرم‌افزاری به پول و نهایتاْ سود برای یک کسب‌وکار است.

ارزش کار مهندس نرم‌افزاری که نتواند گزارش‌های دقیق در مورد عملکرد خود به مدیران یا مشتریان خویش تحویل دهد برای سازمان‌ها بسیار کمتر از ارزش کار کسی است که در گزارش‌دهی تبهر دارد. ولی بسیاری از مهندسین نرم‌افزار در سازمان‌های ایرانی در زمینه گزارش‌دهی به مدیران یا مشتریان خود ضعف دارند. برخی یک مقاومت درونی در مقابل این کار دارند و برخی دیگر مهارت‌های لازم برای انجام آن را ندارند. ریشه بسیاری از این نارسایی‌ها به این بر می‌گردد که فرد با دلیل وجود گزارش کار آشنایی ندارد.

علت گزارش کار این نیست که سازمان کنترل کند که کی دارد کار می‌کند و کی کار نمی‌کند. علت آن است که وقتی سازمان می‌داند یک مهندس نرم‌افزار با چه مسائل و مشکلاتی روبرو است، در بسیاری از مواقع می‌تواند در حل آن مسائل به او کمک کند. 

تقریباْ همه مسائل کسب‌وکاری که سازمان‌ها با آن‌ها روبرو می‌شوند راه‌حل‌های مختلفی دارند. برخی از این راه‌حل‌ها هزینه زیادی دارند و برخی ارزان‌تر هستند. برخی از آن‌ها کارآمدی بیشتری دارند و برخی کم‌تر. برخی درازمدت هستند، برخی میان‌مدت و برخی کوتاه‌مدت. برخی سرعت کار سازمان را بالا می‌برند و برخی کیفیت کار را. برخی تنها با استفاده از نرم‌افزار قابل حل هستند و برخی راه‌هایی غیر از تولید نرم‌افزار هم برای حل آن‌ها وجود دارند. برخی علاوه بر حل یک مسئله خاص ارزش‌های کسب‌وکاری دیگری هم در سازمان ایجاد می‌کنند و برخی خیر. گزینه‌هایی که مدیریت یک سازمان برای حل مسائل کسب‌وکاری خود در اختیار دارد معمولاْ بسیار گسترده و متعدد هستند. تنها برخی از این گزینه‌ها معمولاْ نیاز به تولید نرم‌افزار، که کاری بسیار هزینه‌بر و پر ریسک است، دارند.

قبل از اینکه یک سازمان یک پروژه یا کار خاص را به یک مهندس نرم‌افزار محول کند، همیشه یک فرآیند تحلیل در مورد همه گزینه‌های موجود انجام می‌دهد. برآورد آن کار یا پروژه نرم‌افزاری تنها زمانی تعریف می‌شود که نتیجه نهایی آن فرآیند تحلیل نشان می‌دهد که بهینه‌ترین روش برای حل مسئله کسب‌وکاری مربوطه، انجام آن کار یا پروژه نرم‌افزاری خاص است. این ارزیابی نتیجه یک سری داده‌ها و پیش‌فرض‌های خاص است که در حین فرآیند تحلیل از آن استفاده شده است. بخش مهمی از آن داده‌ها و پیش‌فرض‌ها به تخمین‌های سازمان از میزان پیچیدگی، زمان، انرژی و هزینه تولید نرم‌افزار برای حل آن مسئله کسب‌وکاری بر می‌گردد. ولی در بسیاری از مواقع، این تخمین‌ها، داده‌ها و پیش‌فرض‌ها اشتباه هستند. تا کار تولید نرم‌افزار شروع نشود، اطلاعات سازمان در مورد پیچیدگی،‌زمان، انرژی و هزینه لازم برای تولید راه‌حل‌های نرم‌افزاری واقع‌بینانه‌تر نمی‌شوند.

گزارش‌های کار روزانه مهندسین نرم‌افزار است که به مدیران تیم نشان می‌دهد کدام مسائل پیچیده‌تر، زمان‌بر تر، انرژی‌بر تر و یا هزینه‌بر تر از تخمین‌های قبلی سازمان است. 



- یک کار خاص به یک مهندس نرم‌افزار محول شده است. کسی که این کار را به وی محول کرده فکر می‌کرده کار نسبتاْ سریع انجام می‌شود. ولی در عمل، مهندس نرم‌افزار 

گزارش کار مهندسین نرم‌افزار به مدیران و مشتریان اجازه می‌دهد روند پیشرفت پروژه را کنترل کنند و موانعی که جلوی پیشرفت پروژه را . در بسیاری از مواقع، این باعث می‌شود سازمان متوجه شود که  باشد، 
