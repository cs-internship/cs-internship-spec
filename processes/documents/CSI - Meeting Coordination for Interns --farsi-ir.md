...
&nbsp;&nbsp;&nbsp;&nbsp;•  توجه به زمان اسپرینت: حتماً مطمئن شوید که تسکی که انتخاب کرده‌اید مربوط به اسپرینت‌های آتی است. هر اسپرینت یک بازه زمانی مشخص دارد (معمولاً یک هفته) و اگر تسکی در اسپرینت جاری باشد، نمی‌توانید در آن شرکت کنید چرا که جلسات آن در حال برگزاریست. اگر اسپرینت جاری انتخاب شده است، آن را به اسپرینت بعد تغییر دهید.
...
&nbsp;&nbsp;&nbsp;&nbsp;• زمان‌بندی جلسات: اطمینان حاصل کنید که جلسه‌ای که انتخاب می‌کنید در اسپرینت آتی برگزار می‌شود. اگر تسکی مربوط به اسپرینت جاری یا قبل از آن باشد، نمی‌توانید در آن شرکت کنید.

&nbsp;&nbsp;&nbsp;&nbsp;• شروع اسپرینت: بعد از شروع هر اسپرینت، دیگر نمی‌توانید تسک‌های مربوط به آن را تغییر دهید یا به آن اضافه شوید. برای تنظیم جلسات جدید باید به اسپرینت‌های بعد مراجعه کنید.
