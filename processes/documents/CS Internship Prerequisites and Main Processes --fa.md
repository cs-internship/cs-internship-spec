...
یکی از دغدغه‌های جدی که همه سازمان‌ها با آن روبرو هستند که به خصوص در تیم‌های دورکاری نمود خاص پیدا می‌کند آن است که مدیریت سازمان مطمئن نیست مهندسین نرم‌افزار دارند وقت خود را روی چه مسائلی صرف می‌کنند. اکثر برنامه‌نویس‌ها طبیعتاْ دوست دارند بدون اینکه مجبور باشند به شخص دیگری گزارش دهند که دارند روی چه مسائلی کار می‌کنند، کار خود را انجام دهند. این طبیعی است. کلاْ انسان معمولاْ دوست ندارد شخص دیگری نحوه کار کردن او را کنترل کند. ولی یک مهندس نرم‌افزار حرفه‌ای می‌داند که برای عشق خودش کد نمی‌زند، بلکه در راستای تحقق اهداف کسب‌وکاری سازمان یا مشتری خویش کد می‌زند. مهندسین نرم‌افزار می‌دانند که این حق سازمان یا مشتری است که بدانند او دارد چه کار می‌کند و روی حل چه مسائلی وقت می‌گذارد. 
...
بسیاری از مهندسین نرم‌افزار در زمینه گزارش‌دهی به مدیران یا مشتریان خود مشکل دارند. برخی در مقابل این کار مقاومت می‌کنند و برخی دیگر این کار را به درستی انجام نمی‌دهند. ارزش کار مهندس نرم‌افزاری که نتواند گزارش‌های دقیق در مورد عملکرد خود به مدیران یا مشتریان خویش تحویل دهد برای سازمان‌ها بسیار کمتر از ارزش کار کسی است که در گزارش‌دهی تبهر دارد. گزارش کار مهندسین نرم‌افزار به مدیران و مشتریان اجازه می‌دهد روند پیشرفت پروژه را کنترل کنند. در بسیاری از مواقع، این باعث می‌شود سازمان متوجه شود که  باشد، 
