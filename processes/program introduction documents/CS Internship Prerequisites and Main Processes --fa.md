...
یکی از دغدغه‌های جدی که همه سازمان‌ها با آن روبرو هستند و به خصوص در تیم‌های دورکاری نمود پیدا می‌کند آن است سازمان نیاز دارد در جریان دقیق روند پیشرفت کار مهندسین نرم‌افزار قرار بگیرد. اکثر برنامه‌نویس‌ها طبیعتاْ دوست دارند بدون اینکه مجبور باشند به شخص دیگری گزارش کار دهند، کار خود را انجام دهند. این طبیعی است. ولی یک مهندس نرم‌افزار حرفه‌ای می‌داند که برای عشق شخص خود کد نمی‌زند، بلکه در راستای تحقق اهداف کسب‌وکاری سازمان یا مشتری خویش کار می‌کند. فرق برنامه‌نویس و مهندس نرم‌افزار آن است که برنامه‌نویس برای لذتی که از پیاده‌سازی آلگوریتم‌های نرم‌افزاری می‌برد کد می‌زند ولی مهندس نرم‌افزار می‌داند که مسئولیت وی تبدیل آلگوریتم‌های نرم‌افزاری به پول و نهایتاْ سود برای یک کسب‌وکار است.

ارزش کار مهندس نرم‌افزاری که نتواند گزارش‌های دقیقی در مورد عملکرد خود به مدیران یا مشتریان خویش تحویل دهد برای سازمان‌ها کمتر از ارزش کار کسی است که در گزارش‌دهی تبهر دارد. ولی بسیاری از مهندسین نرم‌افزار در سازمان‌های ایرانی در زمینه گزارش‌دهی به مدیران یا مشتریان خود ضعف دارند. برخی یک مقاومت درونی در مقابل این کار دارند و برخی دیگر مهارت‌های لازم برای انجام آن را به صورت بهینه ندارند. ریشه بسیاری از این نارسایی‌ها معمولاْ به این بر می‌گردد که فرد اصولاْ با دلیل نیاز به گزارش کار آشنایی ندارد. علت اصلی گزارش کار این نیست که سازمان کنترل کند چه که کسی دارد کار می‌کند و چه کسی کار نمی‌کند. علت آن است که وقتی سازمان می‌داند یک مهندس نرم‌افزار با چه مسائل و مشکلاتی روبرو است، در بسیاری از مواقع می‌تواند از طرق دیگر در حل آن مسائل به او کمک کند. 
