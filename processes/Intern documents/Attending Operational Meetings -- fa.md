...
## مقدمه
یکی از نیازهای اساسی سازمان‌ها،‌ شرکت‌ها و تیم‌ها، به‌ویژه در حوزه تولید نرم‌افزار، نیاز به برگزاری جلسات منظم برای بررسی پیشرفت روند پروژه‌ها است تا در آن فعالیت‌های انجام شده مرور، نقاط قوت و ضعف و ریسک‌های موجود بررسی و برای ادامه کار برنامه ریزی شود. میزان کارآمدی این جلسات به مهارت اعضا، چه در نقش شرکت‌کننده و چه در جایگاه مدیر جلسه، وابسته است.در برنامه CS Internship نیز با همین رویکرد، جلساتی به‌صورت هفتگی برگزار می‌گردد تا علاوه بر برنامه‌ریزی فعالیت‌ها و ایجاد هماهنگی در تیم، بستری عملی برای تمرین این مهارت‌ها فراهم شود. این جلسات با عنوان «جلسات عملیاتی» شناخته می‌شوند.  
این مستند با هدف معرفی ساختار این جلسات، تبیین چرایی وجود آن‌ها، تشریح مهارتی که در بستر آن‌ها تمرین می‌شود، و نحوه مشارکت در آن‌ها تهیه شده است.
