...
5. **شرکت در جلسه‌ هماهنگ شده:** در جلسه‌ هماهنگ‌شده به‌صورت تصویری شرکت خواهید کرد و این جلسه با حضور دو منتور و اینترن‌هایی که ویدئوی هم‌گروه با شما را مشاهده کرده‌اند برگزار می‌شود. اگر سوال یا ابهامی درباره‌ موضوعات مطرح‌شده در ویدئو داشته باشید، می‌توانید از منتورها بپرسید. هدف این جلسات پرسش از شما درباره‌ موضوعات ویدئو نیست، بلکه فضایی برای گفتگو با منتورها در مورد مفاهیم ارائه‌شده در ویدئو فراهم می‌کند. جلسات کارگاه‌ها در چند روز هفته برگزار می‌شوند و مدت زمان هر جلسه حداکثر نیم ساعت است. با این حال، بسته به سوالات و گفتگوهای مطرح‌شده، این مدت زمان ممکن است تغییر کند، اما از ۳۰ دقیقه تجاوز نخواهد کرد. در صورتی که نیاز به گفتگوی مفصل‌تری درباره‌ موضوعی داشتید، می‌توانید درخواست خود را در گروه CS Internship - Coordination مطرح کنید تا در صورت امکان، جلسه‌ای جداگانه با یک منتور تنظیم شود.

**توجه:** در هر مرحله، ابتدا ویدئوی اول را مشاهده کنید، سپس در جلسه‌ی مربوط به آن شرکت کنید و پس از آن به سراغ ویدئوی دوم بروید.
...
**توجه مهم:**  
- گذراندن پروسه‌ کارگاه‌های منتورشیپ ممکن است زمان‌بر باشند. بنابراین، توصیه می‌شود اینترن برنامه‌ای منظم برای استپ‌ها تنظیم کند، به این معنا که از شروع استپ، به فکر کارهای کارگاه های منتوریگ باشد.
...
**توجه:** در صورتی که اینترن در بازه‌ی تعیین‌شده (۲۴ ساعت) ددلاین خود را اعلام نکند، مشمول **پنالتی** خواهد شد. برای آشنایی بیشتر [مستند پنالتی نقض اینتگریتی](https://github.com/cs-internship/cs-internship-spec/blob/master/processes/documents/CSI%20-%20Process%20-%20Penalty--farsi-ir.md) را مطالعه کنید.
...
وقتی ددلاین جدیدی می‌دهید، تاریخ این ددلاین در پروفایل شخصی شما ثبت می‌شود. درصورتی که تعداد تمدید ددلاین‌هایتان زیاد شود، به این معنا می‌باشد که همان اول استپ نتونسته بودید ددلاین اولیه‌ مناسبی برای استپ خود مشخص کنید و همچنین اگر بیش از دو هفته از ددلاین تعیین‌شده برای استپ بگذرد و تمدیدی انجام نشود، روند خروج شما از دوره به‌صورت خودکار آغاز خواهد شد.  
...
- اگر در یک بازه زمانی ۲۵ ساعت فعالیت داشته‌اید، می‌توانید گزارش‌های خود را در گروه ارسال کنید و با ارسال گزارش‌ها، جلسه فنی با منتور فنی هماهنگ کنید. این جلسات هر هفته توسط منتورهای فنی برگزار می‌شوند. به عبارت دیگر، اگر در هر بازه‌ای ۲۵ ساعت فعالیت داشته باشید و گزارش‌های خود را ارسال کنید، می‌توانید از جلسات فنی هفتگی بهره‌مند شوید.
...
### گروه‌های برنامه
برای آشنایی با هر گروه، می‌توانید پیام‌های پین شده آن‌ها را مطالعه فرمایید.

- CS Internship - Club
- CS Internship - Feed
- CS Internship - Type Racing
- CS Internship - Queue
- CS Internship - Coordination 
- CS Internship - Interview Onboarding
...
6. **تماشای ویدیوهای کارگاه ارتباطات انسانی**  
   اینترن‌ها باید ویدئوهای **کارگاه ارتباطات انسانی** شماره ۲ را مشاهده کرده و گزارش آن‌ها را در بخش **Reports** گروه **CS Internship - Coordination** ارسال کنند. توجه داشته باشید که برای هرکدام از این ویدئوها باید جلسه‌ای جداگانه تنظیم شود.
