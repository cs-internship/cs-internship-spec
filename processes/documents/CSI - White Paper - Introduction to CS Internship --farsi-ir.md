...
برنامه CS Internship یک شخصیت حقوقی ندارد، یعنی یک شرکت، کسب و کار یا آموزشگاه نیست. در حقیقت، این برنامه جامعه‌ای از متخصصین حوزه نرم‌افزار است که داوطلبانه مهارتهای اثرگذاری سازنده و خلق ارزش اقتصادی را در 
راستای تحقق ویژن و پیشبرد ماموریت تیمها، شرکتها، سازمانها به همدیگر یاد می‌دهند و از همدیگر یاد می‌گیریند.
...
برنامه CS Internship از چند دوره آموزشی مختلف تشکیل شده است که هر کدام روی یک شاخه فنی و تخصصی خاص متمرکز است. در حال حاضر، دوره‌های برنامه عبارتند از «توسعه وب»، «برنامه‌نویسی C#» و «یادگیری ماشین». هر فرد فقط می‌تواند در آن واحد در یکی از این دوره‌ها شرکت کند. شرکت‌کنندگان معمولاً بین 25 تا 30 ساعت در هفته روی دوره زمان صرف می‌کنند و بستگی به سرعت یادگیری و حرکت خود، تکمیل کل برنامه معمولاً حدود ۱۵ ماه زمان می‌برد. نهایتا سرعت حرکت هر فرد در برنامه به عهده خود وی است.
...
3. **جبران بهم ریختگی پیش آمده:** وقتی من به حرف خود عمل نکرده‌ام، عملا باعث بهم ریختگی در برنامه دیگران و در نهایت بهم ریختگی سیستم شده‌ام. در این صورت وظیفه و تعهد خود می‌دانم که هر کاری در توانم باشد را برای رفع این بهم ریختگی که برای بقیه به وجود آورده‌ام انجام دهم.
...
اینتگریتی مهمترین اصل این برنامه است. تمام کارهای ما بر پایه این اصل انجام می‌شود. قبل از اینکه وارد دوره‌ آموزشی مورد نظر خود شوید متعهد خواهید شد که به اینتگریتی پایبند هستید.
