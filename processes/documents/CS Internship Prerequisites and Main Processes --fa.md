...
قبل از اینکه یک سازمان یک پروژه یا کار خاص را به یک مهندس نرم‌افزار محول کند، همیشه یک فرآیند تحلیل در مورد همه گزینه‌های موجود انجام می‌دهد. آن کار یا پروژه نرم‌افزاری تنها زمانی تعریف می‌شود که نتیجه نهایی این فرآیند تحلیل نشان می‌دهد که بهینه‌ترین روش برای حل مسئله کسب‌وکاری مربوطه، انجام آن کار یا پروژه نرم‌افزاری خاص است. این ارزیابی نتیجه یک سری داده‌ها و پیش‌فرض‌های خاص است که در حین فرآیند تحلیل از آن‌ها استفاده شده است. بخش مهمی از این داده‌ها و پیش‌فرض‌ها به تخمین‌های سازمان از میزان پیچیدگی، زمان، انرژی و هزینه تولید نرم‌افزار برای حل آن مسئله کسب‌وکاری بر می‌گردد. ولی در بسیاری از مواقع، این تخمین‌ها، داده‌ها و پیش‌فرض‌ها اشتباه هستند. تا کار تولید نرم‌افزار شروع نشود، درک سازمان از پیچیدگی،‌ زمان، انرژی و هزینه لازم برای تولید راه‌حل‌های نرم‌افزاری واقع‌بینانه‌تر نمی‌شوند.
