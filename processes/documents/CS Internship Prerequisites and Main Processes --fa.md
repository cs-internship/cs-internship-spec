...
در برنامه CS Internship، اینترن‌ها همیشه این آزادی را دارند که اگر تشخیص دادند به هر دلیلی قادر به انجام قول خود با کیفیت مناسب در مهلت اعلام شده نیستند، از یک فرآیند خاص برای مذاکره مجدد و تغییر آن قول استفاده کنند. در این فرآیند، یکی از دیگر اینترن‌ها یا منتورهای برنامه به کسی که قول داده است کمک خواهد کرد تا به بررسی دلایلی که باعث عدم تخمین صحیح میزان کار لازم برای تکمیل استپ (یا عدم تکمیل کارهای مربوطه سر زمانی که توسط خود اینترن تعیین شده بود) بپردازد. با بررسی فرایندهایی که اینترن از آن‌ها برای انجام عملیاتی مانند تخمین میزان کار لازم، تخمین میزان زمان لازم برای انجام آن کارها، برنامه‌ریزی برای انجام کارها، نظارت بر روند انجام آن‌ها، تست کردن کارها در ضمن انجام آن‌ها، کنترل کیفیت نتایج نهایی کار، تحویل کار و ارائه گزارش کار استفاده کرده است، اینترن می‌تواند نسبت به سطح مهارت‌ها و نقاط ضعف و فدرت خود در حوزه مدیریت قول آگاه شود و در صورت نیاز، اقدام به توسعه این مهارت‌ها نماید. در صورتی که اینترن بتواند فرآیند مذاکره مجدد قول خود را با موفقیت انجام دهد، او اجازه خواهد داشت که مهلت اعلام شده خود برای استپ را تغییر دهد.
