...
1. **فاز مطالعاتی:** در این فاز تمرکز بر یادگیری مفاهیم نظری و مهارت‌های پایه برنامه نویسی و منتوری است.
2. **فاز کارآموزی عملی:** این فاز متمرکز بر اجرای عملی و به‌کارگیری مهارت‌های کسب‌شده در پروژه‌های واقعی در شرکت‌های طرف قرارداد با برنامه است.
...
- این ویدئوها جلسات کارگاهی هستند که در محیط برنامه Zoom توسط آقای صادقی چند سال پیش برگزار شده‌اند و الان به صورت ویدئوی ضبط شده در دسترس هستند.
- این ویدیوها در سه نمای مختلف ضبط شده‌اند:
...
- هر هفته باید گزارش‌ها در گروه ارسال ‌شود. پس از رسیدن مجموع ساعت فعالیت به ۲۵ ساعت، میتوانید هماهنگی جلسه فنی با منتور فنی را انجام دهید. این جلسات به‌صورت هفتگی توسط منتورهای فنی برگزار می‌شوند.
...
## گروه‌های برنامه
برای آشنایی با هر گروه، می‌توانید پیام‌های پین شده آن‌ها را مطالعه فرمایید.- CS Internship - Club: گروه مخصوص اینترن‌ها که در آن پست‌های مرتبط با استپ‌هایشان را منتشر می‌کنند.
- CS Internship - Feed: کانال اطلاع‌رسانی دوره که تمامی اخبار و اعلان‌های مهم در آن قرار می‌گیرد.
- CS Internship - Type Racing: گروهی برای برگزاری مسابقات تایپ و دورهمی‌های آنلاین، که لینک ورود به رقابت‌ها در اینجا ارسال می‌شود.
- CS Internship - Queue: فضایی برای افرادی که درخواست ورود به دوره را دارند؛ تمامی افراد در صف دوره در اینجا حضور دارند.
- CS Internship - Interview Onboarding: گروهی که افراد پس از رسیدن نوبت ورودشان به دوره در آن عضو شده و مراحل ورودشان انجام می‌شود.
- CS Internship - Coordination شامل چندین تاپیک است که هرکدام کاربرد مشخصی دارند:
  - **Reports**: برای ارسال گزارش‌های مربوط به دوره، مانند تمدید ددلاین‌ها، گزارش‌های هفتگی و کارگاه‌ها.
  - **Meetings**: جهت هماهنگی جلسات و ثبت ساعت‌های برگزاری.
  - **General**: فضایی برای بحث‌های عمومی مرتبط با دوره.
  - **Questions**: مخصوص پرسیدن سوالات و دریافت راهنمایی در مورد دوره و مسائل مرتبط.
...
1. **مطالعه داکیومنت‌های انبوردینگ و هماهنگی جلسه پرسش و پاسخ**
...
2. **ایجاد حساب‌های کاربری در شبکه‌های اجتماعی**  
...
3. **برگزاری جلسه گفتگو با اعضای برنامه**  
...
4. **انتشار پست‌های مربوط به گفتگوها**  
...
6. **تماشای ویدیو کارگاه ارتباطات انسانی**  
