...
(۱) چند ساعت کار روی چه مسائلی صرف شده است و این میزان کار چه کشفیات یا مشاهداتی در مورد مسائل فنی پروژه به دنبال داشته است. این گزارش به صورت روزانه مورد نیاز است. 

(۲) در طول زمان، فرد چه دستاوردهای فنی‌ای به دست آورده است. این گزارش هر موقع یک دستاورد خاص تحقق پیدا می‌کند موضوعیت پیدا می‌کند. 
...
روش اول این است که اینترن‌ها در پایان هر روز کاری یک گزارش مختصر با یک شکل استاندارد برای کوردینیتور خود ارسال می‌کنند که در آن ثبت می‌کنند که چه مقدار زمان روی چه کارهایی وقت صرف کرده‌اند و چه مشاهداتی در مورد خود و کاری که انجام داده‌اند دارند. شکل این گزارش و نحوه تولید و ارسال آن در فایل ... مستند شده است. هدف از این گزارش‌های روزانه عادت دادن اینترن به گزارش مستمر کارکرد روزانه خود است، کاری که در بسیاری از تیم‌های حرفه‌ای مهندسی نرم‌افزار مرسوم است. کیفیت این گزارش‌ها توسط کوردینیتورها کنترل می‌شود تا اینترن در طول زمان مهارت ثبت کارکرد روزانه خود را بهینه نماید.

روش دوم گزارش‌دهی توسط پست گذاشتن در شبکه‌های اجتماعی اتفاق می‌افتد. فلسفه و نحوه انجام این کار در بخش بعدی تشریح شده است.
