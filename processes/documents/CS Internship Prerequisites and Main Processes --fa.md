...
یکی از دغدغه‌های جدی که همه سازمان‌ها با آن روبرو هستند و به خصوص در تیم‌های دورکاری نمود خاصی پیدا می‌کند آن است که مدیریت سازمان مطمئن نیست مهندسین نرم‌افزار دارند وقت خود را روی چه مسائلی صرف می‌کنند. اکثر برنامه‌نویس‌ها طبیعتاْ دوست دارند بدون اینکه مجبور باشند به شخص دیگری گزارش دهند که دارند روی چه مسائلی کار می‌کنند، کار خود را انجام دهند. این طبیعی است. کلاْ انسان لزوماْ دوست ندارد شخص دیگری نحوه کار کردن او را کنترل کند. ولی یک مهندس نرم‌افزار حرفه‌ای می‌داند که برای عشق خودش کد نمی‌زند، بلکه در راستای تحقق اهداف کسب‌وکاری سازمان یا مشتری خویش کد می‌زند. مهندسین نرم‌افزار می‌دانند که این حق سازمان یا مشتری است که بدانند او دارد چه کار می‌کند و روی حل چه مسائلی وقت می‌گذارد. 

این یک نکته کلیدی است. کلاْ فرق برنامه‌نویس و مهندس نرم‌افزار آن است که برنامه‌نویس برای لذتی که پیاده‌سازی آلگوریتم‌های نرم‌افزاری می‌برد کد می‌زند ولی کار مهندس نرم‌افزار تبدیل آلگوریتم‌های نرم‌افزاری به پول برای یک سازمان است.

با این حال،‌ بسیاری از مهندسین نرم‌افزار در زمینه گزارش‌دهی به مدیران یا مشتریان خود مشکل دارند. برخی در مقابل این کار مقاومت می‌کنند و برخی دیگر این کار را به درستی انجام نمی‌دهند. مهندس نرم‌افزاری که نتواند گزارش‌های دقیق در مورد عملکرد خود به مدیران یا مشتریان خویش تحویل دهد، همواره ریسک این را دارد که با چالش‌های سازمانی مختلفی روبرو شود.
