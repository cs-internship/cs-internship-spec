...
3. Add a **header** to Todo app with the following functionality:
   ...
   - Use your GitHub as source control.
4. Achieve [**Vox Populi**](https://stackoverflow.com/help/badges/1108/vox-populi) badge on StackOverflow. (Optional)  
...
5. Achieve [**Nice Answer**](https://stackoverflow.com/help/badges/23/nice-answer) badge on StackOverflow. (Optional)
6. Achieve [**Self Learner**](https://stackoverflow.com/help/badges/14/self-learner) badge on StackOverflow. (Optional)
