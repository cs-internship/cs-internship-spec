...
۲- بررسی افراد غایب در جلسه:
   - اگر افراد نتوانند در جلسه شرکت کند، باید حداکثر تا پیش از شروع جلسه گزارشی شامل وضعیت تسک‌ها، تجربه‌ها و چالش‌های خود به دست مدیر جلسه برسانند. ،منتورها می‌توانند گزارش خود را در تاپیک "Operation" گروه‌ تلگرامی CS Internship Mentors و همیارهای فنی گزارش خود را در تاپیک "meetings" گروه تلگرامی CS Internship - Coordination ارسال کنند و یا به‌ صورت مستقیم برای مدیر جلسه ارسال کنند.
...
۱- بک‌لاگ‌ها و تمپلیت‌های موجود در لیست فیچرهای زیر باید به‌طور مرتب برای هر جلسه اسپرینت توسط مدیر جلسه ایجاد شوند:
...
مدیر جلسه باید تمامی بک‌لاگ‌های ایجاد شده را به خودش اساین کند.
