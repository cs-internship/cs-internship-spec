...
در هر مصاحبه دو نفر مصاحبه کننده و دو داوطلب ورود به برنامه و دو کوردینتور مربوط به هر داوطلب و یک مشاهده‌گر شرکت می‌کنند. هر مصاحبه در یک روز و ساعت مشخص برگزار می‌شود که مسئولیت ایجاد آمادگی و هماهنگی این افراد و نهایتا برگزاری مصاحبه به عهده برنامه‌ریز مصاحبه است. بنابراین برنامه‌ریز مصاحبه با توجه به ظرفیت‌های موجود از صف‌های دوره‌های موجود دو داوطلب را انتخاب می‌کند. همچنین با توجه به ظرفیت تیم منتوری نقش‌های مصاحبه‌کننده‌ها و کوردینتورها را مشخص می‌کند. برنامه‌ریز مصاحبه به منظور اطلاع‌رسانی به داوطلب‌های انتخاب شده و ایجاد آمادگی لازم در آن‌ها برای جلسه مصاحبه، فردی را مسئول آنبورد‌ کردن داوطلب‌ها می‌کند. این فرد نقش آنبوردکننده مصاحبه را دارد که در مستندی مجزا به شرح وظایف آن پرداخته شده است. در این 

# شرح جزئیات

## فرآیند کلی مصاحبه در برنامه CS Internship
برنامه‌ریز مصاحبه برای برنامه ریزی مصاحبه باید از بک‌لاگ تمپلیت مربوط به مصاحبه به اسم «BackLog 15035: [TEMPLATE] Interview [DateTime]: [First Interviewee Name] and [Second Interviewee Name]» یک کپی ایجاد کند. در این بک‌لاگ به ازای تک تک نقشهای لازم برای مصاحبه و نفر آنبوردکننده تسک وجود دارد. برنامه‌ریز مصاحبه می‌بایست براساس ظرفیت‌های موجود این تسک‌ها را به افراد مختلف محول کند. در ادامه تسکهای موجود که باید به افراد اساین شود، تشریح نحوه تصمیم‌گیری و انتخاب آنها گفته خواهد شد.

### مصاحبه‌کننده اول (First Interviewer)
مصاحبه با مشارکت مصاحبه‌کننده اول و دوم پیش مي‌رود بنابراین لازم هست هماهنگی لازم بین این دو نفر برای برگزاری مصاحبه باشد. وظیفه اصلی مصاحبه‌کننده اول ایجاد هماهنگی لازم بین خودش و مصاحبه‌کننده دوم است و مسئولیت پیش بردن و به سر انجام رساندن مصاحبه است. برنامه‌ریز مصاحبه میبایست مصاحبه‌کننده اول را از بین سطح منتور براساس ظرفیت موجود در آن اسپرینت، انتخاب کند.

### مصاحبه‌کننده دوم (Second Interviewer)
مصاحبه کننده دوم به عنوان نفر کمک کننده در مصاحبه است. فرد مسئول این نقش، وظیفه گرفتن جلسه مصاحبه براساس موازین مشخص شده و گرفتن جلسه دیبریف مصاحبه و مشارکت در خود مصاحبه را دارد. مصاحبه‌کننده دوم از افرادی که دارای سطح کاندید‌منتور(منتور یا کاندیدمنتور) هستند، براساس ظرفیت موجود در آن اسپرینت انتخاب می‌شود.

### دو داوطلب حضور در برنامه (Interviewees)
برنامه‌ریز مصاحبه برای مشخص کردن دو داوطلب ورود به دوره میبایست بر اساس تعداد ظرفیت موجود برای مصاحبه هر دوره و ترتیب صف موجود تصمیم‌گیری کند. تعداد ظرفیت موجود مصاحبه برای هر دوره (تعداد مصاحبه‌هایی که برای هر دوره مثلا سی‌شارپ میتوان انجام داد) را کوتا (Quota) می‌نامیم. کوتا برای هر دوره در صفحه [آمار اینترن‌ها و منتورهای فنی](https://onedrive.live.com/view.aspx?resid=A9B215A332F3E600%21392628&id=documents&wd=target%28Mentors%27%20Info.one%7C0D288A60-6B0B-4B53-9631-BAA46BD790A9%2FInterns%20%26%20Technical%20Mentors%20per%20Course%7C2CA154B3-C056-476D-8345-2420F1879AC0%2F%29) مشخص شده است. برنامه‌ریز مصاحبه براساس کوتا مشخص شده می‌تواند تصمیم بگیرد که برای کدام دوره یا دوره‌ها میتوان مصاحبه انجام داد. سپس از گروه تگرامی CS Internship - Queue،‌ که صف‌های داوطلبین ورود به هر دوره در آن مشخص شده است،‌ دو نفر را برای مصاحبه مشخص می‌کند.

### دو کوردینتور (Coordinators)
برنامه‌ریز مصاحبه با توجه به ظرفیت کسانی که دارای سطح کارآموزمنتوری هستند، دو نفر را برای اعطای رول کوردنیتوری انتخاب می‌کند.

### مشاهده‌گر (Observer)
مشاهده گر به روال کلی انجام مصاحبه نظارت می‌کند (جلسه مصاحبه را مشاهده می‌کند). این نقش صرفا می‌تواند به شخصی از سطح منتوری واگذار شود. برنامه‌ریز مصاحبه براساس ظرفیت روی بورد عملیاتی آن اسپرینت می‌تواند برای مصاحبه مشاهده‌گر تعیین کند. قابل ذکر است که در صورت نبود ظرفیت، یک مصاحبه می‌تواند بدون مشاهده‌گر برگزار شود.

### آنبوردکننده (Onboarder)


پس از آنکه برنامه‌ریز مصاحبه برای تک تک کارها (تسک‌ها) نفر انجام دهنده را مشخص کرد، می‌بایست به این افراد اطلاع دهد. همچنین باید زمان مصاحبه را برای کسانی که در خود مصاحبه شرکت دارند، در کلندر ست کند. در ادامه برنامه‌ریز مصاحبه میبایست اطلاعات مصاحبه را در صفحه [برنامه مصاحبه](https://onedrive.live.com/view.aspx?resid=A9B215A332F3E600%21392628&id=documents&wd=target%28Entrance%20Interview.one%7C12807F5D-673D-4191-9C59-CA4C7D96DD21%2FInterview%20Plan%7C4FA7E932-3221-47D8-B62B-26CC1DFE6127%2F%29
onenote:https://d.docs.live.net/a9b215a332f3e600/Documents/CS%20Internship/Entrance%20Interview.one#Interview%20Plan&section-id={12807F5D-673D-4191-9C59-CA4C7D96DD21}&page-id={4FA7E932-3221-47D8-B62B-26CC1DFE6127}&end) در وان نوت اضافه کند. در صورت نیاز هر تغییری در برنامه مصاحبه صورت گرفت باید در این صفحه نیز اطلاعات آپدیت شود.
