...
# چارچوب تعامل، مسئولیت‌پذیری و حفظ سلامت برنامه

**حضور در برنامه CS Internship یک امتیاز است، نه یک حق.**
این امتیاز بر پایه‌ی همکاری، تعامل و تعهد حرفه‌ای اعطا می‌شود و در صورت نیاز، ممکن است بازبینی یا سلب شود.

۱. اگر منتورهای ارشد درخواست جلسه‌ای برای بررسی یک مسئله (اعم از فنی یا تعاملی) داشته باشند، حضور فرد در جلسه ضروری است. در صورت امتناع مکرر و بدون دلیل موجه، پس از تلاش برای گفت‌وگو، امکان سلب امتیاز حضور وجود دارد.
۲. در تعاملات میان اعضای هم‌سطح، اگر یکی از طرفین حاضر به برگزاری جلسه نشود و گفت‌وگو به نتیجه نرسد، موضوع باید به سطوح بالاتر منتقل شود تا حل مسئله توسط آقای مهران داودی و بهزاد صادقی به‌درستی پیش برود.
۳. در شرایط خاص، اگر رفتار یا عملکرد فردی به برنامه آسیب وارد کند و گفت‌وگوها نتیجه ندهد، منتورهای ارشد می‌توانند با دلایل مشخص و با رأی کثریت، پیشنهاد سلب امتیاز را مطرح کنند. این تصمیم تنها پس از بررسی نهایی توسط مسئولان اصلی برنامه اجرا خواهد شد.

تمامی مراحل بر پایه گفت‌وگو، شفافیت و پرهیز از تصمیمات سلیقه‌ای انجام می‌گیرد.
